  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(180deg, #e8edff 0%, #e6eaf7 50%, #fafafa 100%)',
        }}
      >
        {/* Hero Section */}
        <section className="flex items-center justify-center px-4 py-24 text-center">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-gray-900">
              Build Smarter with{" "}
              <span className="text-blue-600">Gryphon CRM</span>
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              A modern CRM for Gryphon Academy. Streamline your operations with
              vibrant design, smooth animations, and an intuitive user experience.
            </p>
            ...
            <div className="space-y-6 text-left">
              <div className="bg-white p-6 rounded shadow">
                <h4 className="font-semibold text-lg">
                  Is Gryphon CRM free to use?
                </h4>
                <p className="text-gray-600 mt-1">
                  Yes, we offer a free tier with core features. Premium plans are
                  also available.
                </p>
              </div>
              <div className="bg-white p-6 rounded shadow">
                <h4 className="font-semibold text-lg">
                  Can I use Gryphon CRM on mobile?
                </h4>
                <p className="text-gray-600 mt-1">
                  Absolutely! Our platform is fully responsive and works across
                  all devices.
                </p>
              </div>
              <div className="bg-white p-6 rounded shadow">
                ...
                <p className="text-gray-600 mt-1">
                  Yes, we use industry-standard encryption and cloud security best
                  practices.
                </p>
              </div>
            </div>
        ...
        <footer className="bg-white text-center py-6 border-t mt-10">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} Gryphon CRM. All rights reserved.
          </p>
        </footer>
      </div>
    </>
