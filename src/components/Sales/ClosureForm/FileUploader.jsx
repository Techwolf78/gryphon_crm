...
const FileUploader = ({
  ...
  const generateSampleFile = () => {
    ...
    const data = [
      ...
      [2, "Deep Mahire", "Symbiosis", "ABC@GMAIL.COM", "8888888888", "26-Jun-04", "FEMALE", "SHIRDI", 2020, 57, 2020,"", "DIPLOMA", "MECHANICAL", 2023, 73, "BTECH", "MECHANICAL", 2026, 66, "MBA", "IT", 2027, 75],
      [3, "Sakshi Patil", "CEOP", "IJK@GMAIL.COM", "7777777777", "22-Sep-03", "FEMALE", "BALLARI", 2020, 62, 2022, 75, "", "", "", "", "BE", "ELECTRICAL & ELECTRONICS", 2026, 89, "", "", "", ""]
    ];
  ...
  return (
    <div className="space-y-2 mt-4">
      ...
      <div className="flex items-center gap-3">
        <div className={`relative flex-1 border-2 rounded-lg transition-colors ${
          hasFileErrors ? 'border-red-500 bg-red-50' : 
          fileName ? 'border-green-500 bg-green-50' : 'border-gray-300'
        }`}>
          <div className="flex items-center p-2">
            <FaFileExcel className={`mr-2 ${
              hasFileErrors ? 'text-red-500' : 'text-green-600'
            }`} size={18} />
