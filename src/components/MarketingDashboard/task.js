const tasksData = [
  {
    ...
    roles: [
      ...
      {
        name: "Ad Videos",
        tasks: ["Admissions Reel", "Admissions Scripts"],
      },
      {
        name: "PPT",
        tasks: [
      ...
      {
        name: "Co-ordination",
        tasks: ["IU Team", "ICEM Team", "IGSB Team", "Vendors"],
      },
      {
        name: "Documentation",
        tasks: [
      ...
      {
        name: "Analysis",
        tasks: ["Requirement Gathering", "Planning"],
      },
      {
        name: "WD Design",
        tasks: ["Design Architecture", "Prototype", "Approval"],
      },
      {
        name: "Coding",
        tasks: ["Source Code", "Frontend / Backend", "Collaboration"],
      },
      {
        name: "Testing",
        tasks: [
      ...
      },
      {
        ...
        tasks: ["Weekly content Calender"],
      },
      {
        name: "Blog Creation",
        tasks: ["Trending Topics", "Technical", "Branding"],
      },
    ],
  },
  {
