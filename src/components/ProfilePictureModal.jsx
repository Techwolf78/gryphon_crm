...
const ProfilePictureModal = ({
  ...
  const handleUpload = async (file) => {
    ...
    try {
      ...
      xhr.open('POST', 'https://api.cloudinary.com/v1_1/da0ypp61n/image/upload');
      xhr.send(formData);
    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-54 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl w-full max-w-md overflow-hidden shadow-xl">
        <div className="border-b border-gray-100 p-4 flex justify-between items-center">
          <h3 className="text-lg font-medium text-gray-800">Update Profile Picture</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
            ...
            <div className="text-center">
              <div className="relative h-20 w-20 rounded-full bg-gray-100 overflow-hidden mx-auto mb-2">
                {currentImage ? (
                  ...
                  defaultIcon ? (
                    <img src={defaultIcon} alt="Default" className="h-full w-full object-cover" />
                  ) : (
          ...
          {/* Avatar Selection */}
          <div className="mb-6">
            <h4 className="text-sm font-medium text-gray-700 mb-3">Or select an avatar:</h4>
