...
const QRCodeGenerator = ({ invoiceNumber }) => {
  const generateQRCode = () => {
    ...
    const invoiceUrl = `http://localhost:5173/invoice/${invoiceNumber}`;
    ...
    <>
      <div className="qr-code-container text-center">
        <img
          ...
          onError={(e) => {
            e.target.src = `https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=http://localhost:5173/invoice/${invoiceNumber}`;
          }}
        />
