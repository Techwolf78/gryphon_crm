...
resumes in a zip folder by 10th July 2025 by 2:00 pm.*
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      // Submit company data to Firestore for each college
      ...
      // Find TPO emails for selected colleges and open emails
      collegesToSubmit.forEach(college => {
        const collegeInfo = collegeData.find(c => c.collegeName === college);
        const tpoEmail = collegeInfo?.tpoEmail || '';
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="1 1 0 102 0V6a1 1 0 00-1-1z"
                            clipRule="evenodd"
                          />
                      </div>
                      </div>
