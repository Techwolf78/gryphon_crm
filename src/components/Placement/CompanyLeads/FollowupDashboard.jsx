...
const FollowupDashboard = ({
  ...
  return (
    <div className="fixed inset-0 mt-18 bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 z-50 overflow-auto">
      <div className="px-2 py-2 ">
        <div className="flex items-center justify-between">
          <h3 className="text-xl font-semibold text-gray-900">Recent Follow-ups Dashboard</h3>
          <div className="flex items-center space-x-2">
            {/* Status Filter */}
            <div className="relative">
              <button
                onClick={(e) => { e.stopPropagation(); toggleFilterDropdown('status'); }}
                className="flex items-center px-3 py-1.5 bg-white/10 hover:bg-white/20 rounded-lg text-gray-900 text-xs font-medium transition-colors"
              >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center px-3 py-1.5 bg-white/10 hover:bg-white/20 rounded-lg text-gray-900 text-xs font-medium transition-colors"
              >
                <span className={`${filters.dateRange === 'all' ? 'text-gray-900' : 'text-blue-600'} text-xs`}>Created: {getDateRangeDisplay()}</span>
                <svg className="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
            ...
            <div
              onClick={onClose}
              className="bg-black text-white hover:bg-gray-800 transition-colors px-2 py-1 rounded flex items-center cursor-pointer text-sm"
            >
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-blue-50 p-4 rounded-lg shadow-lg shadow-blue-500/20 border border-blue-100">
          ...
          <div className="bg-green-50 p-4 rounded-lg shadow-lg shadow-green-500/20 border border-green-100">
            <h4 className="text-sm font-medium text-green-700">{todaysLabel}</h4>
            <p className="text-2xl font-bold text-green-900">{todayFollowUpsCount}</p>
          </div>
          <div className="bg-red-50 p-4 rounded-lg shadow-lg shadow-red-500/20 border border-red-100">
            <h4 className="text-sm font-medium text-red-700">Hot Follow-ups</h4>
            <p className="text-2xl font-bold text-red-900">{hotLeads}</p>
          </div>
          <div className="bg-yellow-50 p-4 rounded-lg shadow-lg shadow-yellow-500/20 border border-yellow-100">
            <h4 className="text-sm font-medium text-yellow-700">Warm Follow-ups</h4>
          ...
          chartsVisible ? (
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-slate-800">Charts</h3>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-linear-to-br from-slate-50 to-blue-50 p-4 rounded-xl shadow-md border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-slate-800">Follow-ups Over Last 7 Days</h3>
                ...
                <div className="bg-linear-to-br from-slate-50 to-blue-50 p-4 rounded-xl shadow-md border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-slate-800">Follow-ups by User</h3>
                  <ResponsiveContainer width="100%" height={250}>
            ...
            <div className="mb-8 flex items-center justify-between py-2 px-4 bg-slate-100 rounded border border-slate-200">
              <h3 className="text-sm font-semibold text-slate-800">Charts</h3>
              <button
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Action Date</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredFollowUps.map((followup) => (
                  <tr key={followup.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-3 py-2 text-sm">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                        followup.status === 'hot' ? 'bg-red-100 text-red-800' :
                        followup.status === 'warm' ? 'bg-yellow-100 text-yellow-800' :
                        followup.status === 'cold' ? 'bg-blue-100 text-blue-800' :
                        followup.status === 'called' ? 'bg-green-100 text-green-800' :
                        followup.status === 'onboarded' ? 'bg-purple-100 text-purple-800' :
