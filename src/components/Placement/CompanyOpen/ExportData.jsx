    ...
    companiesToExport.forEach((company) => {
      ...
      if (grouped[status]) {
        grouped[status].push({
          ...
          "Fixed Salary (LPA)": company.fixedSalary ? formatSalary(company.fixedSalary) : "",
          "Variable Salary (LPA)": company.variableSalary ? formatSalary(company.variableSalary) : "",
          "Total Salary (LPA)": company.salary ? formatSalary(company.salary) : "",
